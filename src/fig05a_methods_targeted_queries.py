"""Fig. 5(a): per-method compression for targeted queries (p_r = 0.5, p_s = .075).

Plots the Lambda bounds and linear-code reference curves against the measured
partition, enumerative-sender, and enumerative-query-complement code sizes.
"""
...
# plot the data for the p_r = 0.5 case
fig = plt.figure()
